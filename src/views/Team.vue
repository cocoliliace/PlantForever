    ...
    return {
      teamData: [
        ...
        },
        {
          ...
          title: "VP of IT",
          photo: "ching",
          story: "As a 17 years old environmentalist, Ching joined PlantForever with the incentive of combating climate change and urban deforestation. With a passion for web developing, Ching is looking forward to not only maximize the ways that people can reach out to PlantForever from everywhere in the world, but to also make the process as simple as possible"
        },
        {
          name: "Fatima Shamas",
...
.profile-cards {
  ...
  .card {
    box-shadow: 0 1px 5px 0 rgba($orange, 0.5);
    margin: 15px;
    width: 650px;
    display: flex;
